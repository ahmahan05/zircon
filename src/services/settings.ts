...
export const saveSettings = createServerFn({ method: "POST" })
  ...
  .handler(async ({ context, data }) => {
    ...
    const settings: AppSettings = {
      language: (map.language as AppSettings["language"]) || "ru",
      currency: (map.currency as AppSettings["currency"]) || "RUB",
      dateFormat: (map.dateFormat as AppSettings["dateFormat"]) || "dd.MM.yyyy",
